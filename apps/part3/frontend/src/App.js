...
const BACKEND_API_URL = window.RUNTIME_ENV.REACT_APP_BACKEND_API_URL;
const APPINSIGHTS_CONNECTION_STRING = window.RUNTIME_ENV.REACT_APP_APPINSIGHTS_CONNECTION_STRING;
